...
Source0  : https://files.pythonhosted.org/packages/2c/3f/c55e896a3d37c7ce100a278ed298e43209f1e7ed6fceccae97654b8b9e44/azure-multiapi-storage-0.5.2.tar.gz
...
%prep
%setup -q -n azure-multiapi-storage-0.5.2
cd %{_builddir}/azure-multiapi-storage-0.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608048202
